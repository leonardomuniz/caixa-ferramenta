...
export class ChinenigansService {
  ...
  create(_createChineniganDto: CreateChineniganDto) {
  ...
  async findAll() {
    ...
    await this.cacheManager.set(
      'chinenigans-find-all',
      `This action returns all chinenigans`,
    );
  ...
  update(id: number, _updateChineniganDto: UpdateChineniganDto) {
